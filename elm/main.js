...
var author$project$Main$GotCalc = function (a) {
	return {$: 'GotCalc', a: a};
};
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Main$calcDecoder = elm$json$Json$Decode$string;
...
var author$project$Main$calcEncoder = function (calc) {
...
var author$project$Main$calculate = function (input) {
	return elm$http$Http$post(
		{
			body: elm$http$Http$jsonBody(
				author$project$Main$calcEncoder(input)),
			expect: A2(elm$http$Http$expectJson, author$project$Main$GotCalc, author$project$Main$calcDecoder),
	...
	function (msg, model) {
		switch (msg.$) {
					...
					return _Utils_Tuple2(
						A2(
							...
							_Utils_ap(
								...
								_List_fromArray(
									[
										_Utils_Tuple2(model.input, val)
									])),
							''),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						A2(author$project$Main$Model, model.log, ''),
						elm$core$Platform$Cmd$none);
				}
			case 'SetCalc':
				var input = msg.a;
			...
			default:
				return _Utils_Tuple2(
					model,
					author$project$Main$calculate(model.input));
		}
	});
var author$project$Main$SetCalc = function (a) {
	return {$: 'SetCalc', a: a};
};
...
var author$project$Main$calcForm = function (model) {
	return A2(
